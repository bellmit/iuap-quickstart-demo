...
!function(modules) {
    ...
    !function(global, factory) {
        ...
        var createDivs = function() {
            ...
            return this.options.showSumRow && (sumRowClass = "u-grid-content-left-sum", this.options.sumRowFirst && (sumRowClass += " u-grid-content-left-sum-first")), 
            this.options.multiSelect && (htmlStr += '<div class="u-grid-content-left ' + sumRowClass + '" id="' + this.options.id + '_content_multiSelect" style="width:' + this.multiSelectWidth + "px;" + hStr + '">', 
            ...
            return this.options.showTree && (classStr += row.hasChild ? " u-grid-content-parent-row " : " u-grid-content-leaf-row ", 
            classStr += 0 == row.level ? " u-grid-content-level0-row " : " u-grid-content-levelother-row "), 
    ...
    !function(global, factory) {
        ...
        var widthChangeFun = function() {
            ...
            if (this.countContentHeight && $("#" + this.options.id).length > 0) {
        ...
        var re_createContentRowsSumRow = function(createFlag) {
            ...
            if (this.options.showSumRow) {
                ...
                return $.each(gridCompColumnArr, function() {
                    ...
                    var tdStyle = "";
                    this.options.visible || (tdStyle = 'style="display:none;"'), htmlStr += '<td role="sumrowcell" title="' + sumValue + '" ' + tdStyle + ">", 
            ...
            if (this.options.showSumRow) {
                ...
                row.style.top = t + "px", $.each(gridCompColumnArr, function() {
                    ...
                    newCell.role = "sumrowcell", newCell.title = sumValue;
                    var contentStyle = "";
                    "integer" != this.options.dataType && "float" != this.options.dataType || (contentStyle = 'style="text-align: right;"');
