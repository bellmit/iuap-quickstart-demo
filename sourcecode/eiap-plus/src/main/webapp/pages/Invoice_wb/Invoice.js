define(['text!./Invoice.html','./meta.js','css!./Invoice.css', '../../config/sys_const.js','css!../../style/style.css','css!../../style/widget.css'], function (template) {
  ...
  //开始初始页面基础数据
    var init =  function (element, params) {
        ...
        var viewModel = {
            draw: 1,//页数(第几页)
            pageSize: 5,
            searchURL: qyctx + '/Invoice/list',
            addURL: qyctx + "/Invoice/add",
            updateURL: qyctx + "/Invoice/update",
            delURL: qyctx + "/Invoice/delBatch",
...
//                    });
                ...
                selectCompany_Invoice: function () {
                    ...
                    var title = '请选择参照值';
                    var url = qyctx + '/Invoice/Company/listall';
                ...
                selectTsi18n_Invoice: function () {
                    var treeSet = this.treeSetting;
                    var title = '请选择参照值';
                    var url = qyctx + '/Invoice/Tsi18n/listall';
