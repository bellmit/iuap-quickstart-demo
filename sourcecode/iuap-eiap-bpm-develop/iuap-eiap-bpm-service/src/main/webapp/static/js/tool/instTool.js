...
define(function (exports, module, require) {
    ...
    var tool = {
        ...
        showLoading: function (id) {
            var htmlStr = '<div class="save-waiting"><img src="./static/images/loading.gif" /><span>请稍候...</span></div>';
            if (id) {
        ...
        confirmDialog: function(options){
            ...
            var confirmDialogTemplate = '<div class="u-msg-dialog" id="u-confirm-dialog">'+
                '<div class="u-msg-title confirm-title">'+
                    ...
                    '<div id="cloDiv" class="closediv"><i id="closeIco" class="uf uf-removesymbol"></i></div>'+
                '</div>'+
                '<div class="u-msg-content">'+
                '<p>{msg}</p>'+
                '</div>'+
                '<div class="u-msg-footer"><button style="border-radius: 4px;height: 30px;line-height: 30px;padding: 0;color:#039BE5;border-color:#039BE5;" id="cancelbtn" class="u-msg-cancel u-button">{cancelText}</button><button id="okbtn" class="u-msg-ok u-button" style="background:' + colorval + ';border-radius: 4px;height: 30px;line-height: 30px;padding: 0;">{okText}</button></div>'+
                '</div>';    
