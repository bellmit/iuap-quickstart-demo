...
@Controller
@RequestMapping(value = "/restrolesynchro")
public class BpmRoleDataSynchroRestController {

	private static final Logger log = LoggerFactory.getLogger(BpmRoleDataSynchroRestController.class);

	@Autowired
	private IEiapBpmUserGroupAdapterService service;
