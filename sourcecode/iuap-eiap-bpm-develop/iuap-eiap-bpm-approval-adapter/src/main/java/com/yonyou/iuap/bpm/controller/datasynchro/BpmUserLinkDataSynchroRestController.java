...
@Controller
@RequestMapping(value = "/restuserlinksynchro")
public class BpmUserLinkDataSynchroRestController {

	private static final Logger log = LoggerFactory.getLogger(BpmUserLinkDataSynchroRestController.class);

	@Autowired
	private IEiapBpmUserLinkAdapterService service;
