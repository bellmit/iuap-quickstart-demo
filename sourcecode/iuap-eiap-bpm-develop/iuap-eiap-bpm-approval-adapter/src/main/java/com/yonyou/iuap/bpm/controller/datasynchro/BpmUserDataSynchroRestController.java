...
@Controller
@RequestMapping(value = "/restusersynchro")
public class BpmUserDataSynchroRestController {

	private static final Logger log = LoggerFactory.getLogger(BpmUserDataSynchroRestController.class);

	@Autowired
	private IEiapBpmUserAdapterService service;
