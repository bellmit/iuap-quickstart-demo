...
import ChildTablezibiaotest01 from '../zibiaotest-childtable01';
        ...
        this.props.form.validateFields(async (err, values) => {
            ...
            if (err) {
                ...
                if (rowData && rowData.id) {
                    ...
                    let {childListzibiaotest,cacheArrayzibiaotest,delArrayzibiaotest} = this.props;
                ...
                <Row className='detail-body'>
                        ...
                        <div className="master-tag">
                            <div className="childhead">
                                <span className="workbreakdown" >zibiaotest</span>
                            </div>
                        </div>
