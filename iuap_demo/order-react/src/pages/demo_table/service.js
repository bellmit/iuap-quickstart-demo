...
//定义接口地址
const URL = {
    "GET_DETAIL":  `${GROBAL_HTTP_CTX}/demo_table/getAssoVo`,
    "SAVE_ORDER":  `${GROBAL_HTTP_CTX}/demo_table/saveAssoVo`,
    "GET_LIST":  `${GROBAL_HTTP_CTX}/demo_table/list`,
    "DEL_ORDER":  `${GROBAL_HTTP_CTX}/demo_table/deleteBatch`,
