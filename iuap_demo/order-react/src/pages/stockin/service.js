...
//定义接口地址
const URL = {
    "GET_DETAIL":  `${GROBAL_HTTP_CTX}/stockin/getAssoVo`,
    "SAVE_ORDER":  `${GROBAL_HTTP_CTX}/stockin/saveAssoVo`,
    "GET_LIST":  `${GROBAL_HTTP_CTX}/stockin/list`,
    "DEL_ORDER":  `${GROBAL_HTTP_CTX}/stockin/deleteBatch`,
...
export const saveStockin = (params) => {
    return request(URL.SAVE_ORDER, {
        method: "post",
        data: params
    });
}
export const delStockin = (params) => {
