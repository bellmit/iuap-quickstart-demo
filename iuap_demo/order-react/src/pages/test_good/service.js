...
//定义接口地址
const URL = {
    "GET_DETAIL":  `${GROBAL_HTTP_CTX}/test_good/list`,
    "SAVE_ORDER":  `${GROBAL_HTTP_CTX}/test_good/save`,
    "GET_LIST":  `${GROBAL_HTTP_CTX}/test_good/list`,    
    "DEL_ORDER":  `${GROBAL_HTTP_CTX}/test_good/deleteBatch`,
...
export const saveTest5 = (params) => {
    return request(URL.SAVE_ORDER, {
        method: "post",
        data: params
    });
}
export const delTest5 = (params) => {
